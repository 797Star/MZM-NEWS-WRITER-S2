          ...
          <>
            ...
            <div className="mt-8 text-center">
              <button
                ...
                className="w-full sm:w-auto bg-neutral-700 hover:bg-neutral-800 disabled:bg-neutral-400 text-white font-semibold py-3 px-10 rounded-sm shadow-md transition-colors duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-neutral-500 focus:ring-offset-2"
                aria-live="polite"
                ...
                {!isLoading && (
                  <div className="mt-6 text-center">
                    <button
                      ...
                      className="w-full sm:w-auto bg-purple-600 hover:bg-purple-700 disabled:bg-purple-300 text-white font-semibold py-3 px-8 rounded-sm shadow-md transition-colors duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2"
              ...
              <div className="mt-8 p-6 bg-purple-50 rounded-none border border-purple-200">
                ...
                <div className="mt-6 text-center">
                  <button
                    ...
                    className="bg-purple-700 hover:bg-purple-800 text-white font-semibold py-2 px-6 rounded-sm shadow-md transition-colors duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2"
            ...
            {generatedScript && !proofreadScript && !isProofreading && (
              <div className="mt-8 text-center">
                <button
                  ...
                  className="bg-emerald-700 hover:bg-emerald-800 text-white font-semibold py-2 px-6 rounded-sm shadow-md transition-colors duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2"
